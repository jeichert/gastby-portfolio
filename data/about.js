module.exports = {
  name: 'Jeffrey Eichert',
  currentPosition: 'Project Coordinator/Job Captain',
  description:
    'My name is Jeffrey Eichert and I’m an Architectural Designer living and working in NYC. I graduated with a Masters in Architecture from Massachusetts College of Art and Design and a BFA in Design/Technology from Emerson College in Boston, MA. I have a passion for learning and a desire to create, and I am not afraid of getting my hands dirty.',
  location: 'New York, NY',
  email: 'jeffrey.eichert@gmail.com',
  schools: [
    {
  ...
  jobs: [
    {
      name: 'J Frankl Associates (JFA)',
      position: 'Project Coordinator/Job Captain',
    ...
    },
    {
      ...
      position: 'Scenery and Props Technician',
      location: 'Boston, MA',
      dates: 'September 2008 - May 2012',
      description: [
  ...
  experience: [
    {
      ...
      osha: {
        name: 'OSHA',
        experience: 'OSHA-10 Certicication',
        location: 'Boston, MA',
